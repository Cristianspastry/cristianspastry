...
interface ScienceIntroductionProps {
  content: any[]
}

export default function ScienceIntroduction({ content }: ScienceIntroductionProps) {
  return (
        ...
        <PortableText
          ...
          components={{
            ...
            marks: {
              ...
              code: ({ children }) => (
                <code className="rounded bg-gray-100 px-2 py-1 text-sm text-orange-600">
                  {children}
                </code>
              ),
            },
