...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-gray-200 bg-white shadow-sm h-16 contain-intrinsic-size">
      <nav className="container mx-auto flex  h-16 items-center justify-between px-4"        style={{ height: '4rem' }} // ← Usa inline style per priorità assoluta
>
        {/* Logo - FIXED: Attributi statici, nessuna logica condizionale */}
        <Link
          href="/"
          className="flex items-center gap-2 flex-shrink-0"
          aria-label="Cristian's Pastry - Torna alla home page"
        >
          <Image
            src="/logo.svg"
            alt="Cristian's Pastry logo"
            width={48}
            height={48}
            priority
            className="h-12 w-12"
            style={{ width: 48, height: 48 }} // ← IMPORTANTE: dimensioni inline
          />
            ...
            return (
              <Link
                ...
                style={{
                  ...
                  fontVariationSettings: isActive ? '"wght" 600' : '"wght" 500', // Smooth transition , 
                  willChange: isActive ? 'color' : undefined
                }}
              >
